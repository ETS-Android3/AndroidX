...
import com.androidx.content.UriProvider;
...
public class Bug implements Thread.UncaughtExceptionHandler {
    ...
    public Bug(Builder builder) {
        ...
        IOProvider.makeDirs(context, dir);
        start();
    }
    ...
    public static class Builder {
         ...
         * 文件夹名称
         */
        private String dir = UriProvider.DIRECTORY_BUG;
         ...
         * 日志名称
         */
        private String name = "BUG_" + Time.now("yyyyMMDD_HHmmss") + ".txt";
    ...
    public void uncaughtException(Thread thread, Throwable throwable) {
        ...
        if (UriProvider.isMounted()) {
            final File file = IOProvider.createFile(context, dir, name);
            //保存错误的日志
            ...
            new RuntimeException("You Sdcard is not exist!");
