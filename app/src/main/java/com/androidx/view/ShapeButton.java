...
public class ShapeButton extends AppCompatTextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            gravity = typedArray.getInt(R.styleable.ShapeButton_android_gravity, gravity);
            ...
            state = typedArray.getInt(R.styleable.ShapeButton_state, state);
