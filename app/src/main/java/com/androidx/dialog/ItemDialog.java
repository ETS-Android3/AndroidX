...
public class ItemDialog {
    ...
    private class ItemDialogAdapter extends BaseAdapter {
        ...
        public ItemDialogAdapter(Context context, CoreDialog dialog, List<ItemDialogBody> items, OnItemDialogClickListener onItemDialogClickListener) {
    ...
    public interface OnItemDialogClickListener {
        ...
        void onItemDialogClick(CoreDialog dialog, List<ItemDialogBody> bodies, int position);
