...
public class RSA {
    ...
    public static void main(String args[]){
        String content = "";
        System.out.println("->decrypt = "+decrypt(content));

        RSA.PUBLIC_KEY = "XXXXXX";
        RSA.PRIVATE_KEY = "XXXXXX";
        String encode = RSA.encrypt("xxxxxxxxx");
        String decode = RSA.decrypt("xxxxxxxxx");
    }
