...
public class Log {
    ...
    public static String format(String header, String content) {
        String[] items = split(content, Log.HEAD_LINE.length());
    ...
    public static String format(String header, String contents[]) {
        ...
        sb.append(Log.NEW_LINE).append(Log.HEAD_LINE).append(Log.NEW_LINE);
        sb.append(Log.LEFT_LINE).append(header).append(Log.NEW_LINE);
        sb.append(Log.MIDDLE_LINE).append(Log.NEW_LINE);
        for (int i = 0; i < contents.length; i++) {
            sb.append(Log.LEFT_LINE).append(contents[i]).append(Log.NEW_LINE);
        }
