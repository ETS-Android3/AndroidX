...
public class DataStorage {
    ...
    public Map<String, String> getStringMap(String key, Map<String, String> defValue) {
        ...
        return Json.parseJSONObject(Decoder.decode(mapValue));
    }
    ...
    public List<Map<String, String>> getStringMapList(String key, List<Map<String, String>> defValue) {
        ...
        return Json.parseJSONArray(Decoder.decode(mapValue));
    }
    ...
    public void put(Object obj) {
        ...
        String objString = Json.parseObject(obj);
        put(obj.getClass().getSimpleName(), Encoder.encode(objString));
    }
    ...
    public <T> T getObject(Class<T> cls) {
        ...
        return Json.parseJSONObject(cls, Decoder.decode(json));
    }
