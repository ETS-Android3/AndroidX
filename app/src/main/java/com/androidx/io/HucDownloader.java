...
public class HucDownloader {
     ...
     * 缓存文件夹
     */
    public static final String DICTIONARY = "Downloader";
    /**
     * 正在下载
     */
    ...
    protected File createFile(String url) {
        File cacheFolder = new File(new IOProvider().makeDirs(context, dictionary == null ? DICTIONARY : dictionary));
            ...
            public void run() {
                ...
                try {
                    ...
                    if (url.toUpperCase().startsWith("HTTPS")) {
                        ...
                        httpsURLConnection.setSSLSocketFactory(Http.options().cert().getSSLSocketFactory());
