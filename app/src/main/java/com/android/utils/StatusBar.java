...
public class StatusBar {
     ...
     */
    public static void setTranslucent(AppCompatActivity activity, View needOffsetView) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
     ...
     */
    public static void setViewTransparent(AppCompatActivity activity, View needOffsetView) {
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setViewTranslucent(AppCompatActivity activity, View needOffsetView) {
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setViewTranslucent(AppCompatActivity activity, @IntRange(from = 0, to = 255) int statusBarAlpha, View needOffsetView) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparentForWindow(activity);
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setViewTranslucentInFragment(AppCompatActivity activity, View needOffsetView) {
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setViewTranslucentInFragment(AppCompatActivity activity, @IntRange(from = 0, to = 255) int statusBarAlpha, View needOffsetView) {
     ...
     * 隐藏伪状态栏 View
     *
     * @param activity 调用的 AppCompatActivity
     */
    public static void hideStatusBarView(AppCompatActivity activity) {
        ViewGroup decorView = (ViewGroup) activity.getWindow().getDecorView();
        View fakeStatusBarView = decorView.findViewById(FAKE_STATUS_BAR_VIEW_ID);
        if (fakeStatusBarView != null) {
     ...
     * @param isDark   是否是黑色
     */
    public static void setFontColor(AppCompatActivity activity, boolean isDark) {
        if (isDark) {
     ...
     */
    private static void addTranslucentFakeStatusBarView(AppCompatActivity activity, @IntRange(from = 0, to = 255) int statusBarAlpha) {
