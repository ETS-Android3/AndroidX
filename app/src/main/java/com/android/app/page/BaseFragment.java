...
public abstract class BaseFragment extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback, PermissionsManager.OnRequestPermissionsListener, OnHttpListener, OnImageSelectListener {
    ...
    protected void setStatusBarColor(int color) {
        ...
        StatusBar.setTranslucent((AppCompatActivity) getActivity());
        StatusBar.setColor((AppCompatActivity) getActivity(), getResources().getColor(color));
        StatusBar.setFontColor((AppCompatActivity) getActivity(), getResources().getColor(color) == Color.WHITE);
    }
